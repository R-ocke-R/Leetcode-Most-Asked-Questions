...
<pre style="position: relative;"><strong>Input:</strong> asteroids = [5,10,-5]
...
<pre style="position: relative;"><strong>Input:</strong> asteroids = [8,-8]
...
<pre style="position: relative;"><strong>Input:</strong> asteroids = [10,2,-5]
